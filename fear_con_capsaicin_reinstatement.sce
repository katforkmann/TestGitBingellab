...
scenario = "fear_con_capsaicin_reinstatement";
pcl_file = "fear_con_capsaicin_reinstatement.pcl";   
	

#==========================================
# auskommentieren, wenn fMRI
#==========================================
...
#==========================================
# auskommentieren, wenn Verhaltenstest
#==========================================
...
$time_pain_event				= 2000;  # evtl hier runter gehen mit der zeit
$dur_anticipation_pain	  	= 2000;
$dur_stimuli_length			= 10000;

$dur_pause_event				= 5000;  # evtl hier runter gehen mit der zeit
$dur_end_event					= 500;  # evtl hier runter gehen mit der zeit
...
# Ende
picture{
	text{caption = "Vielen Dank für die Teilnahme!";font_size = 40;};
   x = 0; y = 0;
}END;

# Instruktionen
#bitmap { filename = "stimuli\\Instr_Experiment_Capsaicin.jpg"; } INSTR;	      # Beschreibung Experiment
bitmap { filename = "stimuli\\Instr_Reinstatement_Capsaicin.jpg"; } INSTR;	# Beschreibung Experiment
bitmap { filename = "stimuli\\Instr_Habituation_Capsaicin.jpg"; } INSTR_HAB;	# Beschreibung Experiment
...
bitmap { filename = "stimuli\\Dreieck.jpg"; } 	Figure_4;

#--------------
# CS Trials
#--------------
trial {stimulus_event{nothing{};} pic1;}CS_Pain;
trial {stimulus_event{nothing{};} pic2;}CS_Minus;
...
picture{					
   text{caption = "Reinforcement";font_size = 48;};
	x = 0; y = 100;
}REINFORCEMENT; # used for checks

picture{					
   text{caption = "eda delay";font_size = 48;};
	x = 0; y = 100;
}EDA_DELAY; # usd for checks
...
trial {
   ...
   picture {bitmap INSTR_HAB;x = 0; y = 0;};
...
trial {
	trial_duration = 500;
	picture{text{caption = "Zu spät!";font_size = 40;}; 
	x = 0; y = -160;  	
	}TOOLATE_text;		
}TOOLATE_TRIAL;
...
trial {
	trial_duration = 3000;
	picture{					
   text{caption = "Vielen Dank für die Teilnahme!";font_size = 48;};
	x = 0; y = 0;   
	}END_text;	
}END_TRIAL;
...
trial{  
   ...
   stimulus_event{     
		nothing {}; #NULL;
		#picture REINFORCEMENT; #Used for checks
      time      = 0;
...
trial{
	trial_duration = $dur_stimuli_length; #$dur_trial; 
 
   stimulus_event{
      picture {};
		time      = 0;				
      duration  = $dur_anticipation_pain;			
      code      = "ANTICIPATION_PAINRELIEF";
...
trial{
   ...
   stimulus_event{
      picture {};
		time      = 0;				
      duration  = $dur_anticipation_pain;			
      code      = "ANTICIPATION_NOCHANGE";
   }ANTICIPATION_NOCHANGE_EVENT;  
   ...
   stimulus_event{
      ...
      duration  = $dur_pain;
      code      = "NOCHANGE";
      port_code = 0;    ## Achtung Port code einstellen!
   }NOCHANGE_EVENT; 
}ANTICIPATION_NOCHANGE_TRIAL;
...
trial{
   ...
   stimulus_event{
		picture{}; #DEFAULT;
		#picture EDA_DELAY; #Used for checks
      code      = "EDA_DELAY";
   }EDA_DELAY_EVENT;
