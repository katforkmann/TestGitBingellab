...
scenario = "fear_con_capsaicin_hab_acq_ext_new_corrected_habtrials.sce";
pcl_file = "fear_con_capsaicin_hab_acq_ext_new_corrected_habtrials.pcl";   	
...
#bitmap { filename = "stimuli\\Instr_VAS_Capsaicin.jpg"; } INSTR_VAS;	# Beschreibung Experiment
...
picture{bitmap { filename = "stimuli\\Dreieck.jpg"; }; x=0;y=100;}	Bild_4;
...
trial {
	...
	#picture{text{caption = "Insruction for VAS here!/n press to continue...";font_size = 40;}; 
	#x = 0; y = 0;  	
	#}VAS_text;	

	picture {bitmap { filename = "stimuli\\Instr_VASCS_Übung_Capsaicin.jpg"; }INSTR_VAS;x = 0; y = 0;}; # OR make a bitmap for this insruction.
}INSTRUCTION_VAS;
